...
namespace SwarmBot.API.IntegrationTests
{
    ...
    {
        public const string SwarmBotServiceBaseRoute = "/swarm-bot/";
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        /// <summary>
        /// Combines the base service route(swarm-bot) with the specific endpoint route.
        /// </summary>
        /// <param name="aSwarmBotApiRouteEndpoint"><see cref="SwarmBotApiRoutes"/></param>
        /// <returns>The full route accessible from the exterior of the docker network.</returns>
        public static string GetFullRoute(string aSwarmBotApiRouteEndpoint)
            => SwarmBotServiceBaseRoute + aSwarmBotApiRouteEndpoint;
