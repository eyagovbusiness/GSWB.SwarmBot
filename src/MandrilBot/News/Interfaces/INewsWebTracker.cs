...
namespace MandrilBot.News.Interfaces
{
    ...
    public interface INewsWebTracker<TNewsMessage>
    {
        /// <summary>
        ...
        public Task<List<TNewsMessage>> GetLastMessageListAsync();
        ...
        public Task<List<TNewsMessage>> GetUpdatesAsync();
        ...
        public Task SendMessage(TNewsMessage aNewsMessage);
