...
namespace SwarmBot.Application
{
    ...
    public interface ISwarmBotChannelsService
    {
        ...
        public Task<IHttpResult<ulong>> CreateCategoryFromTemplate(ulong guildId, CategoryChannelTemplateDTO aCategoryChannelTemplate, CancellationToken aCancellationToken = default);
        ...
        public Task<IHttpResult<DiscordChannel>> GetDiscordChannel(ulong guildId, Func<DiscordChannel, bool> aFilterFunc, CancellationToken aCancellationToken = default);
        ...
        public Task<IHttpResult<ulong>> GetExistingCategoryId(ulong guildId, string aDiscordCategoryName, CancellationToken aCancellationToken = default);
        ...
        public Task<IHttpResult<Unit>> SyncExistingCategoryWithTemplate(ulong guildId, ulong aDiscordCategoryId, CategoryChannelTemplateDTO aCategoryChannelTemplate, CancellationToken aCancellationToken = default);
        ...
        public Task<IHttpResult<Unit>> DeleteCategoryFromId(ulong guildId, ulong aEventCategoryId, CancellationToken aCancellationToken = default);
        ...
        /// <returns><see cref="IHttpResult{Unit}"/> with information about success or failure on this operation.</returns>
        public Task<IHttpResult<Unit>> AddMemberListToChannel(ulong guildId, ulong aChannelId, string[] aUserFullHandleList, CancellationToken aCancellationToken = default);
