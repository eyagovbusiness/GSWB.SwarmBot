...
using SwarmBot.BackgroundServices.News.SlaveServices;
...
namespace SwarmBot.BackgroundServices.News
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>Depends on <see cref="ISwarmBotDiscordBot"/> and <see cref="ISwarmBotChannelsService"/>.</remarks>
    public partial class DiscordBotNewsMasterService : IDiscordBotNewsService
    {
        ...
        /// <summary>
        /// Triggers in parallel every asynchronous <see cref="IDiscordBotNewsService.InitAsync(ISwarmBotChannelsService, TimeSpan)"/> of all the slave news services.
        /// </summary>
        /// <param name="aDiscordChannelsService"></param>
        /// <returns>Awaitable <see cref="Task"/>.</returns>
        public async Task InitAsync(ISwarmBotChannelsService aDiscordChannelsService, TimeSpan aTimeout)
