...
namespace SwarmBot
{
    ...
    public partial class SwarmBotDiscordBot : ISwarmBotDiscordBot, IDisposable
    {
        ...
        public async Task StartAsync()
        {
            ...
            {
                _loggerFactory.CreateLogger(typeof(SwarmBotDiscordBot)).LogError("An error occurred while attempting to start the Discord bot client: {0}. Stack trace: {1} ", lException.ToString(), lException.StackTrace);
            }
        }
